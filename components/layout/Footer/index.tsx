...
const socialsData: SocialNetworks[] = [
  {
    id: 1,
    icon: <FaTwitter />,
    url: "https:/jstwitter.com",
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https:/jsfacebook.com",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "http:jsinstagram.com",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/jareershafiq125",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Hackaton Template1 figma template to code © Made by 
              <Link
                href="https:/github.com/jareerShafiq125"
